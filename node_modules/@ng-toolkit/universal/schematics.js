...
function index(options) {
    ...
    let rule = schematics_1.chain([
        ...
        (tree, context) => {
            const angularVersion = _utils_1.getAngularVersion(tree, options);
            ...
            // add dependencies
            _utils_1.addDependencyToPackageJson(tree, options, '@angular/platform-browser', angularVersion);
            _utils_1.addDependencyToPackageJson(tree, options, '@angular/platform-server', angularVersion);
            _utils_1.addDependencyToPackageJson(tree, options, '@angular/http', angularVersion);
            _utils_1.addDependencyToPackageJson(tree, options, '@nguniversal/module-map-ngfactory-loader', `~${angularMajor}.0.0`);
            _utils_1.addDependencyToPackageJson(tree, options, 'webpack-cli', '^3.1.2');
            _utils_1.addDependencyToPackageJson(tree, options, 'ts-loader', '4.2.0');
            _utils_1.addDependencyToPackageJson(tree, options, '@nguniversal/express-engine', `~${angularMajor}.0.0`);
            _utils_1.addDependencyToPackageJson(tree, options, '@nguniversal/common', `~${angularMajor}.0.0`);
            ...
            if (options.http) {
                _utils_1.addToNgModule(tree, entryModule.filePath, 'imports', 'TransferHttpCacheModule,\nHttpClientModule');
                _utils_1.addImportStatement(tree, entryModule.filePath, 'TransferHttpCacheModule', '@nguniversal/common');
                _utils_1.addImportStatement(tree, entryModule.filePath, 'HttpClientModule', '@angular/common/http');
            }
            ...
            tree.overwrite(`${options.directory}/${mainFilePath}`, entryFileSource.replace(new RegExp(`platformBrowserDynamic\\(\\).bootstrapModule\\(.*\\)[\\s\\S]*.catch\\(.*\\);`), `document.addEventListener('DOMContentLoaded', () => {
...
function createFiles(tree, options) {
    _utils_1.createOrOverwriteFile(tree, `${options.directory}/local.js`, `// generated by @ng-toolkit/universal
    ...
    `);
    _utils_1.createOrOverwriteFile(tree, `${options.directory}/server.ts`, `import 'zone.js/dist/zone-node';
    ...
    `);
    _utils_1.createOrOverwriteFile(tree, `${options.directory}/webpack.server.config.js`, `
    ...
    `);
    _utils_1.createOrOverwriteFile(tree, `${options.directory}/src/main.server.ts`, `import { enableProdMode } from '@angular/core';
    ...
    `);
    _utils_1.createOrOverwriteFile(tree, `${options.directory}/src/tsconfig.server.json`, `{
      ...
      `);
    _utils_1.createOrOverwriteFile(tree, `${options.directory}/src/app/app.browser.module.ts`, `import { NgModule } from '@angular/core';
    ...
    `);
    _utils_1.createOrOverwriteFile(tree, `${options.directory}/src/app/app.server.module.ts`, `import {NgModule} from '@angular/core';
