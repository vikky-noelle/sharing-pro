 ...
 */
export declare function externalSchematic<T>(collectionName: string, schematicName: string, options: T): Rule;
/**
 ...
 * @param options The options to pass as input to the RuleFactory.
 */
export declare function schematic<T>(schematicName: string, options: T): Rule;
