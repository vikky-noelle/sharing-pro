...
var HelpCenterContentComponent = (function () {
    function HelpCenterContentComponent(renderer, getService, router, route) {
        this.renderer = renderer;
        this.getService = getService;
        this.router = router;
        this.route = route;
